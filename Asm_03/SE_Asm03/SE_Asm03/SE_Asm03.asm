...
.const
	...
	L12 BYTE 'Output of line str1 and str2:', 0
	L13 BYTE 'lexicographic string comparison str3 and str4:', 0
	L14 BYTE 'hello', 0
	L15 BYTE 'hello ', 0
	L16 BYTE 'accessing the function ~min~:', 0
	L17 BYTE 'accessing the function ~max~:', 0
	L18 BYTE 'accessing the function ~more~:', 0
	L19 WORD 300
	L20 BYTE 'accessing the function ~equal~, when a=111(binary):', 0
